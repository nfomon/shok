...
# Rules
all: shok_lexer shok_parser shok_compiler shok_vm shok
...
tidy: lexer shok
	rm -f lexer/tiny_lexer_st* lexer/test_lexer parser/*.pyc compiler/*.o shell/file_descriptor.o shell/shell.o parser.log compiler.log

clean:
	rm -f lexer/tiny_lexer_st* lexer/test_lexer parser/*.pyc compiler/*.o shell/file_descriptor.o shell/shell.o shok_lexer shok_parser shok_compiler shok parser.log compiler.log
